	...
	public static partial class LanguageTagExtensions
	{
		...
		public static Language? GetPrefix(this Language language)
		{
			switch (language)
			{
				...
				case Language.SZS: return Language.SGN;
				...
				case Language.WBS: return Language.SGN;
				...
				case Language.YDS: return Language.SGN;
