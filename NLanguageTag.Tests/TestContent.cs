...
namespace NLanguageTag.Tests
{
	...
	{
		public static readonly Registry Registry = Registry.Read(
			typeof(TestContent).Assembly.GetManifestResourceStream("NLanguageTag.Tests.language-subtag-registry")!);
		...
		public static IEnumerable<string> GetExtLanguages() =>
			Registry.ExtLanguages.Select(_ => _.Prefix + "-" + _.Subtag);
	}
}
